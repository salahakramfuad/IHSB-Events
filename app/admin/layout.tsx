...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      <aside className={`relative flex shrink-0 flex-col border-r border-slate-200/80 bg-white transition-all duration-300 ${isCollapsed ? 'w-20' : 'w-64'} h-screen sticky top-0`}>
        {/* Collapse toggle handle - centered vertically on the right edge */}
        <button
